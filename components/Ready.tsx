			...
			<div className="w-full h-full flex justify-center gap-[50px] items-center flex-col">
				<div className="flex flex-col gap-[10px]">
					<h1 className="text-[290px] leading-[230px] lg:text-[220px] lg:leading-[170px] md:text-[180px] md:leading-[140px] sm:text-[120px] sm:leading-[90px] xm:text-[80px] xm:leading-[60px] tracking-[-2.5px] text-center font-bold font-FoundersGrotesk text-secondry uppercase pointer-events-none">
						{site.ready.headingLines.map((line, index) => (
							<span
								key={`${line}-${index}`}
								data-sb-field-path={`ready.headingLines.${index}`}>
				...
				<div className="flex flex-col items-center gap-[10px]">
					<div
						data-sb-field-path="ready.primaryLabel"
						className="flex items-center justify-between bg-secondry cursor-pointer rounded-full group">
						<RoundButton
							href={site.ready.primaryUrl}
							title={site.ready.primaryLabel}
					...
					<p
						data-sb-field-path="ready.orLabel"
						className="text-[20px] font-NeueMontreal text-secondry">
						{site.ready.orLabel}
					</p>
						...
						<Link
							...
							<Rounded className="py-[6px]" backgroundColor="#212121">
								<p
									...
									className="z-10 px-[10px] ml-[15px] py-[6px] group-hover:text-white text-black">
									{site.email}
								</p>
