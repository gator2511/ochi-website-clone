						...
						<div className="grid grid-cols-12 md:flex md:flex-col sm:flex sm:flex-col xm:flex xm:flex-col">
							<div className="col-span-5 border-r border-white/35 md:border-r-0 md:border-b sm:border-r-0 sm:border-b xm:border-r-0 xm:border-b border-white/35 p-[34px] sm:p-[24px] xm:p-[22px] flex flex-col justify-between min-h-[470px] md:min-h-0 sm:min-h-0 xm:min-h-0">
								<div className="flex items-start justify-between gap-[20px]">
									<p className="small-text uppercase text-white/75" data-sb-field-path="promotion.eyebrow">{content.eyebrow}</p>
									<button
										ref={closeButtonRef}
										type="button"
										onClick={close}
								...
								<div className="pt-[45px] md:pt-[30px] sm:pt-[28px] xm:pt-[25px]">
									<p className="font-FoundersGrotesk font-semibold uppercase text-[168px] leading-[0.7] lg:text-[145px] md:text-[118px] sm:text-[102px] xm:text-[86px] tracking-[-4px]" data-sb-field-path="promotion.discount">
										{content.discount}
									</p>
									<p className="small-text uppercase pt-[26px] text-white/80" data-sb-field-path="promotion.expiresLabel">{content.expiresLabel}</p>
								</div>
							</div>

							<div className="col-span-7 p-[38px] lg:p-[34px] md:p-[30px] sm:p-[24px] xm:p-[22px] bg-[#f1f1f1] text-[#212121]">
								<h2 id="gt-promo-title" className="font-FoundersGrotesk font-semibold uppercase text-[82px] leading-[0.83] lg:text-[72px] md:text-[66px] sm:text-[58px] xm:text-[50px] tracking-[-2px]" data-sb-field-path="promotion.heading">
									{content.heading}
								</h2>
								<p className="paragraph max-w-[610px] pt-[28px] text-[#212121]/80" data-sb-field-path="promotion.description">{content.description}</p>
								...
								<Link
									...
									<span data-sb-field-path="promotion.ctaLabel">{content.ctaLabel}</span>
									<ArrowUpRight size={18} strokeWidth={1.5} />
								</Link>

								<p className="mt-[42px] pt-[18px] border-t border-[#212121]/20 text-[12px] leading-[1.45] text-[#212121]/58" data-sb-field-path="promotion.terms">
									{content.terms}
								</p>
							</div>
						</div>
