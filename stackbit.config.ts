...
const models: any[] = [
	{
		...
		fields: [
			...
			stringField("abn"),
			objectField("footerFlags", [imageField("image"), stringField("alt")]),
	...
	},
	{
		...
		fields: [
			...
			objectField("vision", [
				stringField("eyebrow"),
				stringField("title"),
				objectList("items", [...imageFields, stringField("label"), stringField("title")]),
			]),
	...
	},
	{
		...
		fields: [
			...
			objectList("featuredBlogs", featuredBlogFields),
			objectField("publication", [
				stringField("marquee"),
				stringField("heading"),
				textField("description"),
	...
	{
		name: "LocalSEOArticlePage",
		type: "page",
		urlPath: "/blog/local-seo-checklist-darwin-palmerston-businesses",
		filePath: "content/pages/blog-local-seo-darwin-palmerston.json",
		fields: blogArticleFields,
	},
	{
		name: "VaultPage",
		type: "page",
		urlPath: "/the-vault",
		filePath: "content/pages/vault.json",
		fields: [
			...seoFields,
			objectField("hero", [
				stringField("eyebrow"),
