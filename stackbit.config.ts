...
const models: any[] = [
	...
	},
	{
		...
		type: "page",
		urlPath: "/blog/5-signs-your-trade-business-needs-a-better-website",
		filePath: "content/pages/blog-tradie-website.json",
		fields: [
			stringField("slug"),
			...seoFields,
			stringList("keywords"),
			stringField("category"),
			stringField("author"),
			stringField("publishedDate"),
			stringField("updatedDate"),
			stringField("readTime"),
			stringField("title"),
			textField("intro"),
			imageField("heroImage"),
			stringField("heroImageAlt"),
			objectList("sections", [
				stringField("number"),
				stringField("heading"),
				textList("paragraphs"),
			...
			stringField("bottomLineHeading"),
			textField("bottomLine"),
			stringField("faqHeading"),
			objectList("faqs", [stringField("question"), textField("answer")]),
			stringField("ctaEyebrow"),
			stringField("ctaHeading"),
			stringField("ctaLabel"),
			stringField("ctaUrl"),
		],
	},
